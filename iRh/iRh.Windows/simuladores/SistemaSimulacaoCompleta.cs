...
namespace iRh.Windows.simuladores
{
    public partial class SistemaSimulacaoCompleta : Form
    {
        ...
        private void rdPericulosidadeSim_CheckedChanged(object sender, System.EventArgs e)
        {
            ...
            if ( rdValeTransporteSim_CheckedChanged)
            {
            ...
            else if(rdValeTransporteNao_CheckedChanged)
            {
    ...
    private void rdPericulosidadeSim_CheckedChanged(object sender, System.EventArgs e)
        {
            if ( rdValeTransporteSim.Checked)
            {
                if (string.IsNullOrEmpty(txtSalarioBaseSC.Text))
                {
                    MessageBox.Show("Informe seu sálario base: ", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
